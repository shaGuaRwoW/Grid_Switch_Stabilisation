...
% node_1_0 = 50 * randn(2, 1);
% node_2_0 = 50 * randn(2, 1);
% node_3_0 = 50 * randn(2, 1);
% node_4_0 = 50 * randn(2, 1);
% node_5_0 = 50 * randn(2, 1);
...
%
sim_out.resulting_sw.Time = sim_out.resulting_sw.Time * dt;
sim_out.resulting_sw.Name = 'Switching signal';
figure
plot(sim_out.resulting_sw, 'LineWidth', 1.5)
title('')
grid
set(gca, 'FontSize', 20)
